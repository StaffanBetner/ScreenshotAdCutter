  ...
  return (
    <div className="relative flex-1 flex flex-col h-full bg-slate-100 overflow-hidden select-none">
      ...
      <div
        ...
        className="flex-1 overflow-auto p-3 sm:p-6 pb-[480px] sm:pb-36 flex justify-center bg-slate-100 relative"
      >
      ...
      {(() => {
        ...
        const isBottomOffscreen = bottomScreenY > viewportHeight - 210;
        const isTopOffscreen = topScreenY < 40 && bottomScreenY > 60;
          ...
          <>
            {isBottomOffscreen && (
              <button
                ...
                className="fixed bottom-64 lg:bottom-48 left-1/2 -translate-x-1/2 z-40 bg-rose-600 active:bg-rose-700 hover:bg-rose-500 text-white text-xs font-bold px-3.5 py-2 rounded-full shadow-xl flex items-center gap-1.5 border border-rose-400/50 animate-bounce transition touch-manipulation whitespace-nowrap"
              >
            ...
            {isTopOffscreen && (
              <button
                ...
                className="fixed top-24 left-1/2 -translate-x-1/2 z-40 bg-slate-900 active:bg-slate-800 text-white text-xs font-bold px-3.5 py-2 rounded-full shadow-xl flex items-center gap-1.5 border border-slate-700 transition touch-manipulation whitespace-nowrap"
              >
      ...
      {(() => {
        ...
        return (
          <div className="fixed bottom-16 lg:bottom-5 left-3 right-3 sm:left-auto sm:right-6 z-40 bg-white/95 backdrop-blur-md rounded-2xl shadow-xl border border-slate-200 p-2.5 flex flex-col gap-2 max-w-sm sm:w-84 mx-auto transition-all animate-in fade-in slide-in-from-bottom-3">
            {/* Header: Title, Minimera/Expandera, Klar */}
            <div className="flex items-center justify-between px-1">
              ...
              <div className="flex items-center gap-1 shrink-0">
                <button
                  ...
                  className="text-xs text-slate-600 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 px-2 py-0.5 rounded-lg font-medium transition"
